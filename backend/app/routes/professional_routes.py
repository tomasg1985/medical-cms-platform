...
from app.schemas.professional_schema import ProfessionalCreate, ProfessionalResponse, ProfessionalUpdate, ProfessionalClinicResponse
...
@router.post("/{professional_id}/clinics/{clinic_id}", response_model=ProfessionalClinicResponse)
def add_clinic_to_professional_endpoint(
    ...
    try:
        professional_clinic = add_clinic_to_professional(
            db=db,
